...
MRESULT EXPENTRY BasClientWndProc(HWND hwnd, USHORT msg, MPARAM mp1, MPARAM mp2)
{
...
long pascal far MakeLong (long passedlong)
{
return passedlong;
} /* makelong */

void pascal far BreakLong (int hiword, int loword, int *phiword, int *ploword)
{
*phiword = hiword;
*ploword = loword;
}
